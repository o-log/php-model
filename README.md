...
#<a name="sql_migration"/> Миграция структуры БД
...
Утилита запросит нужные данные и внесет изменения в класс модели, сгенерирует sql-скрипт обновления таблицы БД и создаст метод выборки объектов по новому полю.
